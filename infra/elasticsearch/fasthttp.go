...
func (ft *FastTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	ft.copyResponse(res, fres)

	return res, nil
}

// copyRequest - converts http.Request to fasthttp.Request
func (ft *FastTransport) copyRequest(dst *fasthttp.Request, src *http.Request) *fasthttp.Request {
...
func (ft *FastTransport) copyResponse(dst *http.Response, src *fasthttp.Response) *http.Response {
